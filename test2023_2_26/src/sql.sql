...
into score(score, student_id, course_id) values
-- 黑旋风李逵
...
select * from student,score where student.name = '许仙';
select * from score,student where student.name = '许仙' and student.id = score.student_id;
...
select student.name,sum(score.score) from student,score where student.id = score.student_id;
